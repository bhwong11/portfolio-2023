...
export default function Contact(){
  ...
  return (
    <section ref={ref} id={links.contact}>
      <motion.section
        className="bg-white border border-black rounded-lg px-3 py-5 shadow-md mb-10 sm:mb-14 text-center"
      ...
      <p className="text-gray-700 mt-6">
        ...
        <form className="mt-10 flex flex-col" onSubmit={sendEmailHandler} ref={ref}>
            ...
            <button
              className="flex items-center justify-center gap-2 h-[3rem] w-[8rem] bg-gray-900 text-white rounded-full outline-none transition-all focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 disabled:scale-100 disabled:opacity-50 px-3"
              disabled={pending}
            >
              Send Email
